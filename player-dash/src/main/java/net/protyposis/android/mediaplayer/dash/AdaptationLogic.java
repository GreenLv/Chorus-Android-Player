...
public interface AdaptationLogic {
     ...
     */
    void reportSegmentDownload(AdaptationSet adaptationSet, Representation representation,
                               Segment segment, int segmentIndex, int byteSize,
                               long downloadTimeMs);

    /**
     * Returns the recommended representation at the time of calling.
     */
    Representation getRecommendedRepresentation(AdaptationSet adaptationSet, int segmentIndex);
}
